            ...
            <div key={data._id}>
              ...
              <div className="EAchAssignedTeamtaskDeleteAndStatusDiv">
                ...
                data.status !== "In Progress" ? (
                  <FontAwesomeIcon
                    icon={faTrashCan}
                    onClick={() => HandleDeleteAssignedTask(data._id)}
                    id="DeleteAssignedTaskIcon"
                  />
                ) : null}
                <p
                  className={
                    data.status === "Not Started"
                      ? "statusOfAssignedNotStartedTask text"
                      : data.status === "In Progress"
                      ? "statusOfAssignedInProgressTask text"
                      : "statusOfAssignedCompletedTask text"
                  }
                >
                  {data.status}
                </p>
