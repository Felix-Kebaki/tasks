...
import { useGetEachLengthQuery,useAsPerPriorityQuery,useAsPerStatusQuery,useGetMonthlyUsageQuery } from "../../redux/api/dashboardApiSlice"
...
const [usageData, setUsageData] = useState([]);
  ...
  if(!Pdata || !Sdata || !Ldata || !Mdata || usageData.length===0 || usageLabels.length===0){
    return(
      <div>Loading....</div>
    )
  }
    ...
    <section className="DashboardMainSec">
      <div className="DashboardMainDiv">
        <div className="DashboardTopMainDiv">
          <p className="GreetingsAndNamePtag text">Greetings ,{userInfo.firstName} {userInfo.lastName}</p>
